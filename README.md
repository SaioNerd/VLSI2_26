...
**Project Context**
This chip was designed as part of the [VLSI design](https://vlsi.ethz.ch/wiki/Main_Page) course at ETH Zurich which uses a (mostly) open source design flow for its exercises. Students are required to modify a Croc based SoC to improve its capabilities somehow to pass the course.
